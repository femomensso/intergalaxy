                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        ...
                        <div class="p-6">
                            <div class="flex items-center">
                                ...
                                <div class="ml-4 text-lg leading-7 font-semibold">{{$produto->nome}} | R$ {{$produto->preco}}</div>
                            </div>
                            ...
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    {{$produto->descricao}}
                                    <hr>
                                    <a style="font-weight: bold" href="{{ route('produto', ['id'=>$produto->id]) }}">Ver produto</a>
                                </div>
                            </div>
                        </div>     
                        @endforeach  
